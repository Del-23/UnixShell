...
/**
 * Tells the system what to perform after that specific signal has been received
 *
 * @param sig_num number associated with the received signal, int this case, ctrl+c = SIGINT and crtl+z = SIGSTOP
 */
